...
class HomeController extends Controller
{
    public function index(){
        $categories=Category::where('status', 1)->latest()->limit(12)->get();
        $subcategories=SubCategory::where('status', 1)->latest()->limit(12)->get();
        $brands=Brand::where('status', 1)->latest()->limit(12)->get();
        $units=Unit::where('status', 1)->latest()->limit(12)->get();
