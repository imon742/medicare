        ...
        <div class="payment-method">
            <div class="input-radio">
                ...
                <div class="caption">
                    ...
                    <p style="color: #D10024;"> You are selected cash on delivery.</p>
            ...
            <div class="input-radio">
                ...
                <div class="caption">
{{--                    <p>Send Money on this number. Save the transcetion ID for verification. Bkash- 01717202172(personal)</p>--}}
                    <p> Send Money on this number. Save the transcetion ID for verification.</p>
                    <p style="color: #D10024;"> Bkash- 01717202172(personal)</p>
            ...
            <div class="input-radio">
                ...
                <div class="caption">
                    ...
                    <p> Send Money on this number. Save the transcetion ID for verification.</p>
                    <p style="color: #D10024;"> Rocket- 01717202172(personal)</p>
                </div>
            </div>
            <div class="input-radio">
                ...
                <div class="caption">
                    <p> Send Money on this number. Save the transcetion ID for verification.</p>
                    <p style="color: #D10024;"> Nogod- 01717202172(personal)</p>
                </div>
            </div>
        </div>
